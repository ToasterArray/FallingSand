    ...
    for row in range(cells.shape[0]):
        ...
        for col in range(cells.shape[1]):
            if cells[row][col] == sand:   
                if row + 1 < ROWS and cells[row + 1][col] == 0:  # fall straight down
                    updated_cells[row][col] = 0
                    updated_cells[row + 1][col] = 1
                elif row + 1 < ROWS and col - 1 >= 0 and cells[row + 1][col - 1] == 0 and direction == 'left':  # fall left
                    updated_cells[row][col] = 0
                    updated_cells[row + 1][col - 1] = 1
                elif row + 1 < ROWS and col + 1 < COLS and cells[row + 1][col + 1] == 0 and direction == 'right':  # fall right
                    updated_cells[row][col] = 0
                    updated_cells[row + 1][col + 1] = 1
